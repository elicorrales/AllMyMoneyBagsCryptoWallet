//wallet-new-select-ui-js/wallet-new-select-ui-page-included-scripts.js
...
const scriptList = [
  ...
  // important scripts.
  //================================================================
  { src: "SimpleWebPageCryptoWallet-new-or-select.js" }
...
async function loadScriptsSequentially(scripts) {
  ...
  //console.log("\n\nWallet New Or Select Wallet Page - Completed Loading Scripts\n\n");
}
